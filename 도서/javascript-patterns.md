...
- [Javascript Patterns [도서](http://www.kyobobook.co.kr/product/detailViewKor.laf?mallGb=KOR&ejkGb=KOR&barcode=9788966260157)](#javascript-patterns-도서httpwwwkyobobookcokrproductdetailviewkorlafmallgbkorejkgbkorbarcode9788966260157)
    - [목차](#목차)
    - [1장](#1장)
    - [2장 기초](#2장-기초)
...
- 함수는 객체다. 즉 함수를 다른 함수에 인자로 전달할 수있다.
...
* 보다시피 자바스크립트에서도 쉽게 비공개 멤버를 구현할 수있다.

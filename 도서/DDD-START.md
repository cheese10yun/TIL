...
- [8장 애그리거트 트랜잭선 관리](#8%EC%9E%A5-%EC%95%A0%EA%B7%B8%EB%A6%AC%EA%B1%B0%ED%8A%B8-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%84%A0-%EA%B4%80%EB%A6%AC)
...
## 응용 서비스 구현
**응용 서비스는 포현 영역과 도메인 영역을 연결하는 매개체 역할**을 하는데 이는 디자인 패턴에서 파사드와 같은 역할을 한다.

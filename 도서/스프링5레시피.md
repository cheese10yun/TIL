...
- [목차](#목차)
- [[레시 핸들러 인터셉터로 요청 가로채기](#레시-핸들러-인터셉터로-요청-가로채기)
    - [과제](#과제)
    - [해결책](#해결책)
    - [풀이](#풀이)
...
- [레시피 [5-6] 리액티브 컨트롤러로 폼 처리하기](#레시피-5-6-리액티브-컨트롤러로-폼-처리하기)
    ...
    - [풀이](#풀이-5)
        ...
        - [폼데이터 검증하기](#폼데이터-검증하기)
- [[레시피 7-1] URL 접근 보안하기](#레시피-7-1-url-접근-보안하기)
    - [과제](#과제-7)
    - [해결책](#해결책-7)
    - [풀이](#풀이-6)
- [[레시피 7-2] 웹 애플리케이션 로그인하기](#레시피-7-2-웹-애플리케이션-로그인하기)
    - [과제](#과제-8)
    - [해결책](#해결책-8)
    - [풀이](#풀이-7)
        - [로그인](#로그인)
        - [로그아웃](#로그아웃)
        - [리멤버 미](#리멤버-미)
- [[레시피 7-3] 유저 인증하기](#레시피-7-3-유저-인증하기)
    - [과제](#과제-9)
    - [해결책](#해결책-9)
    - [풀이](#풀이-8)
        - [인메모리 방식으로 유저 인증하기](#인메모리-방식으로-유저-인증하기)
        - [DB 조회 결과에 따라 유저 인증하기](#db-조회-결과에-따라-유저-인증하기)
        - [패스워드 암호화](#패스워드-암호화)
        - [LDAP 저장소에 조화 결과에 따라 유저 인증하기](#ldap-저장소에-조화-결과에-따라-유저-인증하기)
- [[레시피 7-4] 접근 통제 결정하기](#레시피-7-4-접근-통제-결정하기)
    - [과제](#과제-10)
    - [해결책](#해결책-10)
    - [풀이](#풀이-9)
        - [표현식을 이용해 접근 통제 결정하기](#표현식을-이용해-접근-통제-결정하기)
        - [Spring Security Expressions 정리](#spring-security-expressions-정리)
...
- [[레시피 7-7] 도메인 객체 보안 처리하기](#레시피-7-7-도메인-객체-보안-처리하기)
    - [과제](#과제-11)
    - [해결책](#해결책-11)
        - [퍼미션(Permission, 인가 받은 권한)](#퍼미션permission-인가-받은-권한)
        - [보안 식별자(SID, Security IDentity)](#보안-식별자sid-security-identity)
    - [풀이](#풀이-10)
        - [ACL 서비스 설정하기](#acl-서비스-설정하기)
        - [도메인 객체에 대한 ACL 관리하기](#도메인-객체에-대한-acl-관리하기)
        - [표현식을 이용해 접근 통제 결정하기](#표현식을-이용해-접근-통제-결정하기-1)
- [[레시피 11-1] 스프링 배치 기초 공사하기](#레시피-11-1-스프링-배치-기초-공사하기)
    - [과제](#과제-12)
    - [해결책](#해결책-12)
    - [풀이](#풀이-11)
- [[레시피 11-2] 데이터 읽기/쓰기](#레시피-11-2-데이터-읽기쓰기)
    - [과제](#과제-13)
    - [해결책](#해결책-13)
    - [풀이](#풀이-12)
        - [잡구성하기](#잡구성하기)
        - [입력](#입력)
        - [출력](#출력)
- [[레시피 11-3] 커스텀 ItemWriter/ItemReader작성하기](#레시피-11-3-커스텀-itemwriteritemreader작성하기)
    - [과제](#과제-14)
    - [해결책](#해결책-14)
    - [풀이](#풀이-13)
        - [커스텀 ItemReader 작성하기](#커스텀-itemreader-작성하기)
        - [커스텀 ItemWriter 작성하기](#커스텀-itemwriter-작성하기)
- [[레시피 13-4] 스프링에서 이메일 보내기](#레시피-13-4-스프링에서-이메일-보내기)
    - [과제](#과제-15)
    - [해결책](#해결책-15)
    - [풀이](#풀이-14)
        - [SMT 이메일 서버 구성](#smt-이메일-서버-구성)
        - [JavaMail API로 이메일 보내기](#javamail-api로-이메일-보내기)
        - [스프링 MailSender로 이메일 보내기](#스프링-mailsender로-이메일-보내기)
        - [이메일 템플릿 정의하기](#이메일-템플릿-정의하기)
- [[레시피 13-5] 스프링 쿼츠로 작업 스케줄링하기](#레시피-13-5-스프링-쿼츠로-작업-스케줄링하기)
    - [과제](#과제-16)
    - [해결책](#해결책-16)
    - [풀이](#풀이-15)
        - [스프링 없이 쿼츠 직접 사용하기](#스프링-없이-쿼츠-직접-사용하기)
        - [스프링 이용해 쿼츠 사용하기](#스프링-이용해-쿼츠-사용하기)
- [[레시피 13-6] 스프링에서 작업 스케줄링하기](#레시피-13-6-스프링에서-작업-스케줄링하기)
    - [괘제](#괘제)
    - [해결책](#해결책-17)
    - [풀이](#풀이-16)
...
### 도메인 객체에 대한 ACL 관리하기
백엔드 서비스와 DAO에는 의존성 주입을 이용해서 앞서 정의한 ACL 서비스를 이용하여도 도메인 객체용 ACL을 관리해야합니다. 가령 스케줄 관리 앱에서는 할 일을 등록/삭제할 떄마다 각각 ACL/생성 삭제해야합니다.
...
## 과제
* 쿼츠 스케줄러를 이용해서 잡 스케줄링을 구성 하세요

## 해결책
* 스프링 제공하는 쿼치 유틸리티 클래스를 이요하면 쿼치 API를 직접 프로그래밍하지 않고 잡을 스케줄링할 수 있습니다.
...
```
```java
// 60초마다 한번씩 처음 한번은 5초 있다가 파일을  복제 잡을 생항하는 스케줄러입니다.
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // SimpleTrigger 객체를 만들어 스케줄링 프로퍼티를 구성하고 마지막에 이 트리거로 잡을 싱핼할 스케줄러를 설정합니다.
...
public class QuartzConfiguration {
    ...
    // SimpleTriggerFactoryBean는 JobDetail 객체 레퍼린스를 필요로 하며 시작 시간이나 반복 횟수처럼 자주 쓰이는 스케줄러 프로퍼티 값을 설정 할 수있음
    ...
    @Bean
    @Autowired
    // CronTriggerFactoryBean을 이용한 스케줄링 방식
...
# [레시피 13-6] 스프링에서 작업 스케줄링하기

## 괘제
쿼츠를 쓰지 않고 크론 표현식으로 주기나 빈도를 설정하여 일관된 방향으로 메서드가 실해 되도록 스케줄링 하고 싶습니다.
...
@Configuration
@EnableScheduling
// @EnableScheduling 애너테이션을 이용해서 스케줄링을 활성화
